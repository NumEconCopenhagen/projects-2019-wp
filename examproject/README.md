...
* [dataproject](/examproject/dataproject): The structure is as follows: it contains a jupyter notebook where all the results should be presented. Furthermore, there is a python module named the dataproject where you can write and structure all your code.
* [/examproject](/examproject/examproject): Same structure as above.
* [/modelproject](/examproject/modelproject): Same structure as above.
